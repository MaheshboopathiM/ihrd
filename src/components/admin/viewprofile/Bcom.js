...
import ViewProfiledetails from '../../../components/others/viewProfiledetails'
import { BASEURL } from '../../../BaseUrl/Baseurl';
import axios from 'axios';

function Bcom({ data, filter,handleBcom,setShowsucess,setsucessmessage }) {
    ...
    return (
        <>
                            ...
                            <tbody>
                             ...
                             <div className='container mt-2'>
                                 <Alert variant={"primary"}>
                                     No data Available Please Add Student Details details!
                                 </Alert>
                             </div>
                         }
                        </Table>
            ...
            {View &&
                <ViewProfiledetails show={View}  close={handleClose} data={viewdetails} role={false} handleBcom={handleBcom} setShowsucess={setShowsucess} setsucessmessage={setsucessmessage}/>
            }
        </>
    )
}
