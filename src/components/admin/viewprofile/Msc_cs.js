...
function Msc_cs({ data, filter,handleMsc,setShowsucess,setsucessmessage }) {
    ...
    return (
        <>
                            ...
                            <tbody>
                              ...
                              <div className='container mt-2'>
                                  <Alert variant={"primary"}>
                                      No data Available Please Add Student details!
                                  </Alert>
                              </div>
                          }
                        </Table>
            ...
            {View &&
                <ViewProfiledetails show={View} close={handleClose} data={viewdetails} role={false} handleMsc={handleMsc} setShowsucess={setShowsucess} setsucessmessage={setsucessmessage}/>
            }
        </>
    )
}

export default Msc_cs;