...
function Bsc_cs({ data, filter, handleBsc, setShowsucess, setsucessmessage }) {
    ...
    return (
        <>
            ...
            {View &&
                <ViewProfiledetails show={View} close={handleClose} data={viewdetails} role={false} handleBsc={handleBsc} setShowsucess={setShowsucess} setsucessmessage={setsucessmessage} />
            }
        </>
    )
}

export default Bsc_cs;