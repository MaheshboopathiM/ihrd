...
import FirstYear from './bscProfileForms/FirstYear';
import SecondYear from './bscProfileForms/SecondYear';
import ThirdYear from './bscProfileForms/ThirdYear';
            ...
            {firstyear || secondyear || thirdyear ||
                <Container style={{ width: '80%' }}>
                    <Card className="text-center">
                        ...
                        <Card.Body>
                            <Card.Title>SELECT YEAR OF STUDENT IN BSC(CS)</Card.Title>
                            <Card.Text>
